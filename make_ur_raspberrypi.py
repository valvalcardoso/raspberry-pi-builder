...
#imagens e áudios
bg = load("img", False, "/storage/emulated/0/Download/myprojectbg.jpg", width, height)

tittle = load("img", False, "/storage/emulated/0/Pictures/Picsart/Picsart_22-03-06_13-40-06-952.png", 600,190)

board_img = load("img",False, "/storage/emulated/0/Pictures/15 Sem Título_20220305211848.png", 800,600)

join_audio = pg.mixer.Sound("/storage/emulated/0/Download/Efeito sonoro click do mouse.mp3")

join_audio.set_volume(1.0)

isso_bb = pg.mixer.Sound("/storage/emulated/0/Ringtones/Music Player/eita bb.mp3")

nao_bb = pg.mixer.Sound("/storage/emulated/0/Ringtones/Music Player/aí não bb.mp3")

nao_bb.set_volume(1.0)

isso_bb.set_volume(1.0)

aê = pg.mixer.Sound("/storage/emulated/0/Download/aplausos.mp3")

aê.set_volume(0.7)

components_img = {"cpu" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~5.jpg", 130, 100), 
"ram" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~6.jpg", 100,100), 
"fonte" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~9.jpg", 80,43), 
"usb2" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~4.jpg", 150,85), 
"usb3" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~3.jpg", 150,85), 
"w&b" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~8.jpg", 93,85), 
"audio" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~7.jpg", 70,100), 
"ethernet" : load("img", False, "/storage/emulated/0/Download/71-2nd6QRnL._AC_SL1400_~2.jpg", 170,100)
}
